...
enum class AndroidSound(val resourceId: Int) {
    ...
    OVERTIME_CALL_HELE_TY(R.raw.overtime_hele_ty),
    OVERTIME_CALL_KARTY_VSICHNI(R.raw.overtime_karty_vsichni_zahraji_ted),
    OVERTIME_CALL_KONEC_KARTU(R.raw.overtime_konec_kartu_zahrat_ted_hned),
    OVERTIME_CALL_MACKU_NOTAK(R.raw.overtime_macku_notak),
    OVERTIME_CALL_NA_KOHO_DO_PULNOCI(R.raw.overtime_na_koho_to_cekame_do_pulnoci),
    OVERTIME_CALL_NA_KOHO_DO_ZEJTRA(R.raw.overtime_na_koho_to_cekame_do_zejtra),
    OVERTIME_CALL_NA_KOHO_CEKAME(R.raw.overtime_na_koho_to_cekame),
    OVERTIME_CALL_TAK_NA_KOHO(R.raw.overtime_tak_na_koho_se_ceka),
    OVERTIME_CALL_TAK_POJD(R.raw.overtime_tak_pojd_dej_to_tam),
    OVERTIME_CALL_TAKOVA_DOBA(R.raw.overtime_takova_doba_to_neni_mozny),
    OVERTIME_CALL_TENHLE_TAH(R.raw.overtime_tenhle_tah_je_u_konce_pokracujem),
    OVERTIME_CALL_TEZKEJ_VYBER(R.raw.overtime_tezkej_vyber_co),
    OVERTIME_CALL_TO_JE_DOBA(R.raw.overtime_to_je_doba),
    OVERTIME_CALL_TRI_DVA_JEDNA(R.raw.overtime_tri_dva_jedna_konec),
    OVERTIME_CALL_UZ_JSME_CEKALI(R.raw.overtime_uz_jsme_cekali_dost_dlouho),
    OVERTIME_CALL_ZAHRAJ_SRDICKEM(R.raw.overtime_zahraj_to_srdickem),
}
